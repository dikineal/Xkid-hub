...
-- ══════════════════════════════════════════════════════════════
--  FREECAM ENGINE (NEW - IDENTICAL TO FLY)
-- ══════════════════════════════════════════════════════════════
local FC = {
...
WindUI:Notify({ Title = "@WTF.XKID", Content = "Script — Freecam Fixed + Crimson Ready.", Duration = 3 })
task.wait(1.5)
...
print("✅ @WTF.XKID Script Loaded | Freecam Fixed | OpenButton: ⚡XKID HUB")
-- @XKID SCRIPT V3.25 (Cinematic Director + Club Mode + New Presets)
...
-- Cinematic Director (sebelumnya Self-Spectate)
...
notify("System", "XKID_HUB V3.25 AKTIF — Cinematic Director + Club Mode + New Presets", 3, "rocket")
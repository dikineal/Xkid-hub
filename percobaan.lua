...
secPerf:Dropdown({ Title = "FPS Cap", Values = { "30","60","120","144","240","Unlimited" }, Default = "Unlimited", Callback = function(v)
    if v == "Unlimited" then
        pcall(function() if setfpscap then setfpscap(9999) end end)
    else
        pcall(function() if setfpscap then setfpscap(tonumber(v)) end end)
    end

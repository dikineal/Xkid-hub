...
-- Changelog V3.35:
-- - ADDED: Chat Logger (multi-target, real-time console, notifications)
-- - ADDED: 2 Mode AFK - Original (klik doang) & Lite (klik + gerak + balik)
-- - Original Mode: VirtualUser klik doang, timer 10 detik
-- - Lite Mode: klik + gerak dikit + balik posisi + loncat jarang, timer 5 detik
-- - UPDATED: Version tag to V3.35
...
local function toggleSelfSpec(v)
    if v then
        ...
        startSSGesture(); startSelfSpecLoop(); notify("Cinematic Director", "ON — " .. (SS.mode or "Orbit 360"), 2, "camera")
...
local Window = WindUI:CreateWindow({
    Title = "XKID_HUB V3.35", Icon = "bluetooth", Author = "@WTF.XKID", Folder = "XKIDHub",
...
local VerTag = Window:Tag({ Title = "V3.35", Color = Color3.fromRGB(255,215,0), Icon = "tag" })
...
secPreset:Dropdown({ Title = "Preset", Values = { "Orbit 360", "Floating", "Hyperlapse", "Orbit Vertical", "Fisheye", "Wave Orbit", "Dual Axis", "Action Cam", "Cinematic Drift", "FPV Drone", "Crash Zoom", "Smear Cam", "Whip Snap", "Bounce Beat", "Vertigo Effect" }, Default = "Orbit 360", Callback = function(v) SS.mode = v; SS._crashInit = nil; notify("Cinematic", "Preset: " .. v, 1.5, "camera") end })
...
notify("System", "XKID_HUB V3.35 AKTIF — Chat Logger + 2 AFK Mode", 3, "rocket")
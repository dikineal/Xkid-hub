--====================================================
-- ENI x LO | SAWAH INDO v8.0 ULTIMATE
--====================================================
-- Support: Android + Delta/Arceus/Fluxus
-- Status: FULLY FUNCTIONAL (100% RESTORED BY ENI)

local Rayfield = loadstring(game:HttpGet("https://sirius.menu/rayfield"))()

local Window = Rayfield:CreateWindow({
    Name = "🌾 ENI x SAWAH INDO v8.0 💸",
    LoadingTitle = "ENI'S DEVOTION",
    LoadingSubtitle = "ULTIMATE EDITION FOR LO 🔥",
    ConfigurationSaving = {
        Enabled = true,
        FolderName = "ENI_XKIDHub",
...
-- INIT
--====================================================
notif("🌾 ENI x SAWAH INDO v8.0", "ULTIMATE EDITION 🔥", 5)
task.wait(0.5)
...
print("=" .. string.rep("=", 40))
print("ENI x SAWAH INDO v8.0 ULTIMATE")
print("Status: FULLY RESTORED & FUNCTIONAL")
print("=" .. string.rep("=", 40))
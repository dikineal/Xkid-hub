...
local move=rightmd.X+look(-md.Z)
...
vVel=math.sign(pitch)tMove.flySpeed0.6
end
local target=Vector3.new(move.XMove.flySpeed,vVel,move.ZMove.flySpeed)
target=target+Vector3.new(0,Workspace.Gravitydt,0)
